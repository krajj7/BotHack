...
(def monster-types [
  ...
  (MonsterType. "gargoyle", \g, :brown, 6, 10, -4, 0, -9, #{:genocidable}, [(MonsterAttack. :claw :physical 2 6) (MonsterAttack. :claw :physical 2 6) (MonsterAttack. :bite :physical 2 4)], 1000, 200, :grunt, :human, #{:stone}, #{}, #{:humanoid :thick-hide :breathless :hostile :strong})])

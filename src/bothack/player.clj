...
(defn have-levi [game]
  (have game #(#{"boots of levitation" "ring of levitation"}
...
(defrecord Player
  ...
  (hasIntrinsic [player i] (boolean ((:intrinsics player) (.getKeyword i))))
  (nickname [player] (:nickname player))
  (title [player] (:title player))
  (HP [player] (:hp player))
  (maxHP [player] (:maxhp player))
  (PW [player] (:pw player))
  (maxPW [player] (:maxpw player))
  (AC [player] (:ac player))
  (experienceLevel [player] (:xplvl player))
  (inventory [player] (:inventory player))
  (isTrapped [player] (boolean (:trapped player)))
  (isStatDrained [player] (boolean (:stat-drained player)))
  (hasLycantrophy [player] (boolean (:lycantrophy player)))
  (isStoning [player] (boolean (:stoning player)))
  (isBlind [player] (boolean (blind? player)))
  (isStunned [player] (boolean (:stun (:state player))))
  (isIll [player] (boolean (:ill (:state player))))
  (isDizzy [player] (boolean (dizzy? player)))
  (canEat [player item] (boolean (edible? player item)))

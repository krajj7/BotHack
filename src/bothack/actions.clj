...
(gen-class
  ...
  :methods [^:static [Attack [bothack.bot.Direction] bothack.bot.IAction]
            ...
            ^:static [Contribute [bothack.bot.Direction int] bothack.bot.IAction]
            ^:static [Pay [bothack.bot.IPosition] bothack.bot.IAction]
            ^:static [Repeated [bothack.bot.IAction int] bothack.bot.IAction]
            ^:static [withReason [String bothack.bot.IAction] bothack.bot.IAction]
            ^:static [withHandler [bothack.bot.IAction Object] bothack.bot.IAction]
